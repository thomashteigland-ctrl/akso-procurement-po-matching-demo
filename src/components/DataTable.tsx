import { docTypeLabel, formatNok } from '../lib/format'
            ...
            {visible.length === 0 ? (
              ...
              visible.map((row, index) => (
                ...
                >
                  ...
                  <td className="px-3 py-1.5 font-medium text-ink">{row.supplier}</td>
                  <td className="px-3 py-1.5 font-mono text-xs">{row.poNumber}</td>
                  <td className="px-3 py-1.5 text-right font-mono">{formatNok(row.amount)}</td>
