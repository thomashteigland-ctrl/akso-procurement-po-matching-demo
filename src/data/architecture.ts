...
export const ARCHITECTURE_NODES: ArchitectureNode[] = [
  {
    ...
    subtitle: 'OC, DN, invoices by email',
    icon: 'database',
  },
  {
    id: 'sap-ecc',
  ...
  },
  {
    ...
    subtitle: 'PO, OC, DN, Invoice rows',
    icon: 'database',
  },
  {
    id: 'vector-store',
  ...
  },
  {
    ...
    subtitle: 'Structure & 4-way match',
    icon: 'bot',
  },
  {
    id: 'validator-agent',
  ...
  },
  {
    ...
    layer: 'dashboard',
    title: 'Ask data',
    subtitle: 'Spend & unit-price views',
    icon: 'user',
  },
  {
    id: 'dash-alerts',
...
export const WORKFLOW_STEPS: WorkflowStep[] = [
  {
    ...
    label: 'Overview',
    caption:
      'Vendors email into Outlook. Agents reach OneDrive and other stores through internal systems (Outlook, SAP, Excel), then write back. Click a step to follow one path.',
    nodeIds: [],
    edgeIds: [],
    triggerNodeIds: [],
  },
  {
    ...
    caption:
      'Starts when a PO hits the shared inbox. Inbox ingest hands it to the extractor and matcher, which feeds Processing and passes through the PO validator.',
    nodeIds: ingestNodes,
    edgeIds: ingestEdges,
